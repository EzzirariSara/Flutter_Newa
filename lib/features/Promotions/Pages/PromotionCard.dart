...
//               price: promotion.discountedPrice.toStringAsFixed(2),
//             ),
//           ),
//         );
//       }, 
...
//                                   children: [
//                                     Text(
//                                       "${promotion.discountedPrice.toStringAsFixed(2)} DH",
//                                       style: const TextStyle(
//                                         fontWeight: FontWeight.bold,
//                                         fontSize: 16,
...
//                                     Text(
//                                       "${promotion.originalPrice.toStringAsFixed(2)} DH",
//                                       style: const TextStyle(
//                                         fontSize: 11,
//                                         color: Colors.grey,
...
//                                     double? parsedPrice;
//                                     try {
//                                       parsedPrice = double.parse(promotion.discountedPrice.toString());
//                                     } catch (_) {
//                                       parsedPrice = null;
//                                     }
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            // Pourcentage de promotion à gauche
            Positioned(
              top: 8,
              left: 8,
              child: Container(
